...
MKLOOP 32,5,31, _Div_Tab_32_ , _CST_32_, _Draw_UVc_32_8

MKLOOP 16,4,15, _Div_Tab_16_ , _CST_16_, _Draw_UVc_16_8

MKLOOP 8,3,7, _Div_Tab_8_ , _CST_8_, _Draw_UVc_8_8

MKLOOP 4,2,3, _Div_Tab_4_ , _CST_4_, _Draw_UVc_4_8

MKLOOP 2,1,1, _Div_Tab_2_ , _CST_2_, _Draw_UVc_2_8
